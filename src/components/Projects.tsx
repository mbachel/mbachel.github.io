...
const projects = [
    // Cloud & DevOps
    {
        ...
        category: ["cloud", "web-dev"],
        startDate: "05/2026",
        endDate: "05/2026",
        image: "images/resume.png",
        github: "https://github.com/mbachel/cloud-resume",
        link: "https://resume.bachelder.me",
        class: "Passion Project",
        techs: ["AWS SAM", "Lambda", "Python", "S3", "CloudFront", "API Gateway", "DynamoDB", "ACM", "GitHub Actions"],
        description: "Serverless resume website hosted on AWS. Static front end served via S3 and CloudFront, with a Python Lambda function tracking visitor counts through API Gateway and DynamoDB. Infrastructure managed with AWS SAM; deployments automated through GitHub Actions.",
    },
    ...
    // Web Development
    {
        ...
        startDate: "01/2026",
        endDate: "05/2026",
        image: "images/divitup.png",
        github: "https://github.com/mbachel/DivItUp",
        link: "https://divitup.org",
        class: "ITSC 4155 - Software Engineering Capstone",
        techs: ["Next.js", "FastAPI", "MySQL", "Docker Compose", "GitHub Actions"],
        description: "A full-stack group expense and chore tracking app built as a capstone project. Features a Next.js frontend, FastAPI backend, and MySQL database, containerized with Docker Compose. Served as Git lead, reviewing and merging 50+ pull requests.",
    },
    {
...
export default function Projects() {
    ...
    const getProjectImage = (project: typeof projects[0]) => {
        ...
        const themeableProjects = ['Personal Website', 'M62', 'Cloud Resume Challenge'];
        ...
        <div className="container mx-auto px-4 py-8" id="projects">
            ...
            <div ref={gridRef} className="w-full">
                ...
                {projects.map((project) => (
                    <div
                        key={project.name}
                        className={`grid-item w-full md:w-1/2 lg:w-1/3 p-4 ${project.category.join(' ')}`}
                    >
